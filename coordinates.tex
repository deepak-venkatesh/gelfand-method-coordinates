...
\textbf{(b)}
The solution for $|x| > 3$ will be $(-\infty, -3) \cup (3, \infty)$
...
\begin{tikzpicture}[scale=1.0]
    ...
    % Vertical connectors
    \draw[blue, thick] (-3,0) -- (-3,0.7);
    \draw[blue, thick] (3,0) -- (3,0.7);

    % Solution arrows
    \draw[blue, ->, very thick] (-3,0.7) -- (-5.5,0.7);
    \draw[blue, ->, very thick] (3,0.7) -- (5.5,0.7);

    % Open circles
    \draw[blue, thick, fill=white] (-3,0.7) circle (3pt);
    \draw[blue, thick, fill=white] (3,0.7) circle (3pt);
...
\textbf{(c)}
The solution for $|x| \le 5$ will be $[-5, 5]$
...
\begin{tikzpicture}[scale=0.7]
    ...
    % Solution interval
    \draw[blue, very thick] (-5,0.7) -- (5,0.7);
...
\textbf{(d)}
This means that $x$ is between 3 and 5 when $x$ is positive and it will be between $-5$ and $-3$ when negative. 

The solution set is $(-5, -3) \cup (3, 5)$
...
\begin{tikzpicture}[scale=1.0]
    ...
    % Solution interval
    \draw[blue, very thick] (-5,0.7) -- (-3,0.7);
    \draw[blue, very thick] (3,0.7) -- (5,0.7);
...
\textbf{(e)}
There will be two cases for $|x - 2|$ as shown below.
...
This will be true for all $x < 2$

Thus the solution will be $x \le 2$ and the set will be $(-\infty, 2]$
...
\begin{tikzpicture}[scale=1.0]
    ...
    % Open circle
    \draw[blue, thick, fill=blue] (2,0.7) circle (3pt);
